    ...
    def register(self):
        ...
        def save_settings():
            ...
            allowed = [
                ...
                "jarvis_temperature", "jarvis_max_tokens", "jarvis_system_prompt", "jarvis_ha_control", "tab_order", "filter_labels", "briefing_targets", "briefing_time", "briefing_enabled", "ha_external_url",
            ]
